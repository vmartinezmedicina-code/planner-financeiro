...
INSERT INTO "new_Transaction" ("amount", "bankId", "categoryId", "createdAt", "creditCardId", "description", "eventDate", "id", "isRecurring", "recurrenceRule", "settlementDate", "status", "updatedAt", "userId") SELECT "amount", "bankId", "categoryId", "createdAt", "creditCardId", "description", "eventDate", "id", "isRecurring", "recurrenceRule", "settlementDate", "status", "updatedAt", "userId" FROM "Transaction";
